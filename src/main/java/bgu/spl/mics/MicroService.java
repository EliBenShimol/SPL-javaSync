...
public abstract class MicroService implements Runnable {
    ...
    private  Future f;
    private HashMap <Class<? extends Message>, Callback<? extends Message>> callbackHashmap=new HashMap<>();
    ...
    public final void run() {
        ...
        while (!terminated) {
            synchronized (this) {
                try {
                    Message message = m.awaitMessage(this);
                    if (message.getClass() == null) {
                        wait();
                    } else {
                    }
                    Callback<Message> c = (Callback<Message>) callbackHashmap.get(message.getClass());
